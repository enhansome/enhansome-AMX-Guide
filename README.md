...
[OpenWiFi](https://github.com/open-sdr/openwifi) ⭐ 4,793 | 🐛 95 | 🌐 C | 📅 2026-08-25 is an open-source IEEE802.11/Wi-Fi baseband chip/FPGA design.
...
[LLVM Project GitHub](https://github.com/llvm/llvm-project//) ⭐ 40,412 | 🐛 39,032 | 🌐 LLVM | 📅 2026-09-11
...
[cuML](https://github.com/rapidsai/cuml) ⭐ 5,276 | 🐛 812 | 🌐 Python | 📅 2026-09-11 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.

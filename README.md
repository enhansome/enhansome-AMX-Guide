...
[LLVM Project GitHub](https://github.com/llvm/llvm-project//) ⭐ 40,318 | 🐛 38,928 | 🌐 LLVM | 📅 2026-09-08
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,199 | 🐛 233 | 🌐 Rust | 📅 2026-09-07 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.

...
1. [Getting Started with Advanced Matrix Extensions (AMX)](https://github.com/mikeroyal/AMX-Guide#getting-started-with-amx) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

2. [FPGA Development](https://github.com/mikeroyal/AMX-Guide#fpga-development) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

3. [LLVM Development](https://github.com/mikeroyal/AMX-Guide#llvm-development) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

4. [C/C++ Development](https://github.com/mikeroyal/AMX-Guide#cc-development) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

5. [Linear Algebra](https://github.com/mikeroyal/AMX-Guide#Linear-Algebra) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

6. [Virtualization](https://github.com/mikeroyal/AMX-Guide#virtualization) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

7. [Parallel Computing](https://github.com/mikeroyal/AMX-Guide#Parallel-Computing) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

8. [OpenCL Development](https://github.com/mikeroyal/AMX-Guide#opencl-development) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

9. [CUDA Development](https://github.com/mikeroyal/AMX-Guide#cuda-development) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

10. [Algorithms](https://github.com/mikeroyal/AMX-Guide#algorithms) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

11. [Machine Learning](https://github.com/mikeroyal/AMX-Guide#machine-learning) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

12. [Deep Learning Development](https://github.com/mikeroyal/AMX-Guide#Deep-Learning-Development) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11

# Awesome Getting Started with AMX with stars

[Back to the Top](https://github.com/mikeroyal/AMX-Guide#table-of-contents) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11
...
[Tile control register (TILECFG)](https://en.wikichip.org/wiki/x86/amx) is a process that allows a programmer to configure the size of those tiles (in terms of rows and bytes\_per\_row). Depending on the algorithm being implemented, the size of the tile can be changed to more naturally represent that algorithm.
...
[Apio](https://github.com/FPGAwars/apio) ⭐ 1,005 | 🐛 45 | 🌐 Python | 📅 2026-08-27 is a multiplatform toolbox, with static pre-built packages, project configuration tools and easy command interface to verify, synthesize, simulate and upload your verilog designs.
...
[LLVM Project GitHub](https://github.com/llvm/llvm-project//) ⭐ 39,975 | 🐛 38,470 | 🌐 LLVM | 📅 2026-08-27
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,531 | 🐛 50 | 🌐 C++ | 📅 2026-08-08 is a very fast, header-only/compiled, C++ logging library.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,152 | 🐛 227 | 🌐 Rust | 📅 2026-08-27 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,280 | 🐛 709 | 🌐 Python | 📅 2026-08-25 for high performance training and inference.
...
[Caffe](https://github.com/BVLC/caffe) ⭐ 34,556 | 🐛 1,590 | 🌐 C++ | 📅 2024-07-31 is a deep learning framework made with expression, speed, and modularity in mind. It is developed by Berkeley AI Research (BAIR)/The Berkeley Vision and Learning Center (BVLC) and community contributors.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/AMX-Guide/pulls) ⭐ 118 | 🐛 0 | 🌐 C++ | 📅 2022-01-11.

...
[LLVM Project GitHub](https://github.com/llvm/llvm-project//) ⭐ 40,004 | 🐛 38,603 | 🌐 LLVM | 📅 2026-08-30
...
[cuML](https://github.com/rapidsai/cuml) ⭐ 5,272 | 🐛 844 | 🌐 Python | 📅 2026-08-28 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.
